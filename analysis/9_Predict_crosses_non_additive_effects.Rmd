...
#####################################
#
## vector of selected parents ID’s
#
#####################################
```{r}
...
#####################
```{r}
saveRDS(crossPredsAD,file = here::here("output","cross_genomicPredictions_non_additive.rds"))
...
############################
```{r}
crossPredsA<-readRDS(here::here("output","cross_genomicPredictions_non_additive.rds"))
```
...
top10crosses<-crossPredsAD$tidyPreds[[1]] %>% 
     filter(Trait=="SELIND") %>% 
